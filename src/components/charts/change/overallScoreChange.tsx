                ...
                error ? <p>{(error as SerializedError).message}</p> :
                    ...
                    <div className="flex flex-col overflow-hidden">
                        <div className="flex justify-between">
                            <img src={flag as string} alt="Flag" className="w-32 h-20 rounded-xl" />
                        ...
                        <div className="py-3">
                            <div className="relative h-5 w-full rounded-lg overflow-hidden bg-stone-200">
                                <div
                                    ...
                                    style={{ width: (data.score_difference > 0 ? data.score_difference : - data.score_difference)  + '%', backgroundColor: `${data.score_difference > 0 ? 'green' : 'red'}` }}
                                ></div>
                            </div>
                        </div>
                    </div>
