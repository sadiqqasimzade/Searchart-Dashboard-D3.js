                ...
                isLoading ? <p>Loading</p> :
                    error ? <p>Error</p> :
                        ...
                        (tableMode ? <div className="">
                            ...
                            <div className="flex flex-col pt-2 max-h-[120px] overflow-auto">
                                <div className='px-2'>
                                    {data.map((d, index) => <div key={d.indicator} className='grid gap-2 rounded-md px-3 py-2 bg-transparent  dark:odd:bg-[#152134] dark:even:bg-transparent' style={{ gridTemplateColumns: '2fr 6fr 2fr' }}>
                                        ...
                                        <p className="text-start text-sm truncate ... hover:text-clip hover:whitespace-normal">{d.indicator}</p>
                            ...
                            <p className="text-start text-xs truncate ... hover:text-clip hover:whitespace-normal">{d.indicator}</p>
