    ...
    return (
        <>
            <div className='flex justify-center gap-6'>
                <button className='flex dark:bg-headLink bg-white dark:border-darkHeadLinkBorder border-2 p-2 rounded-md' onClick={() => dispatch(changeTableMode(false))}>
                    Chart
                ...
                <button className='flex dark:bg-headLink bg-white p-2 rounded-md dark:border-darkHeadLinkBorder border-2' onClick={() => dispatch(changeTableMode(true))}>
                    Table
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
